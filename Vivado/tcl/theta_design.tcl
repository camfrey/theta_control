...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {927.148} \
   CONFIG.CLKOUT2_PHASE_ERROR {622.384} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {5.12} \
