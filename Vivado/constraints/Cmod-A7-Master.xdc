...
## LEDs
#set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { PWM }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { xadc_AD4N }]; #IO_L1N_T0_AD4N_35 Sch=ain_n[15]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { xadc_AD4P }]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
...
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { PWM }]; #IO_L2P_T0_34 Sch=pio[26]
