...
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports {button[0]}]
...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {switch[0]}]
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports {switch[1]}]
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports {switch[2]}]
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {switch[3]}]
